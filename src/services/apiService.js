...
class ApiService {
   ...
   * Submit KYC with files + form fields (multipart/form-data).
   * Files: aadhaarFront, aadhaarBack, panFront, supportingDoc (optional)
   * Fields: fullLegalName, dateOfBirth, nationality, countryOfResidence,
   *         city, stateProvince, phoneNumber, streetAddress,
   *         aadhaarNumber, panNumber, termsAgreed
   */
  submitKyc(formData) {
