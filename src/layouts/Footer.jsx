          ...
          <div className="col-12">
            <div className="footer__main">
              <div className="block-text center">
                <h4 className="heading">Get Newsletter</h4>
                <p className="desc">Get updated with news, tips &amp; tricks</p>
              ...
              <p>Copyright © {new Date().getFullYear()}, Growith. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
