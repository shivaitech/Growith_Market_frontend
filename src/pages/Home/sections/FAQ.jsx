...
const faqItems = [
  ...
  { id: 6, cat: 1, q: 'How is my token allocation calculated?', a: 'Tokens Allocated = Investment Amount ÷ Issuance Price. For example, if the issuance price is $0.01 and you invest $1,000, you receive 100,000 tokens. The issuance price is fixed during the offering window.' },
