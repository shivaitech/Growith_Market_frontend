...
const faqItems = [
  { id: 1, q: 'What is Growith?', a: 'Growith is a private digital security offering platform operated through a RAKEZ-established holding structure. It is not a crypto exchange or NFT marketplace. We connect qualified investors with private placement opportunities in high-growth companies.' },
  ...
  { id: 4, q: 'What is ShivAI?', a: 'ShivAI is the first token offering available on Growith. It represents a private placement investment in an AI infrastructure company. The token is issued at a fixed primary offering price defined by the RAKEZ-registered issuer.' },
  { id: 5, q: 'Can I trade the tokens after receiving them?', a: 'Tokens in the current phase are issued as early-stage access before broader market infrastructure matures. Growith is actively building the technical and compliance framework for future peer-to-peer transfers between verified investors and regulated exchange integration, targeting framework readiness by Q3 2027.' },
